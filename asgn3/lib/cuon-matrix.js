 ...
 */
Matrix4.prototype.multiplyVector3 = function(pos, dest) {
  var e = this.elements;
  var p = pos.elements;
  var result;
  var v;
...
class Vector3 {
    ...
    /**
      ...
      * @return new vector
      */
    static cross(other1, other2, dest) {
        // Insert your code here.
        ...
        if(dest){
          dest.elements[0] = x; // Modify this line to calculate cross product between other1 and other2.
          dest.elements[1] = y;
          dest.elements[2] = z;
          return;
        }
    ...
    magnitude() {
        // Insert your code here.
        var e = this.elements;
        let m = Math.sqrt(e[0]**2 + e[1]**2 + e[2]**2);
